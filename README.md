...
For detailed information about the API and available request/response formats, refer to the [![API Documentation](https://img.shields.io/badge/API%20Documentation-View%20Now-blue?style=for-the-badge&logo=appveyor)](./API_documentation.md)
